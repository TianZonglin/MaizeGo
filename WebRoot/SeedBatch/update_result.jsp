...
<script type="text/javascript"> 
  ...
  ArrayList<String> rs=(ArrayList)attribute.get("borrow_info");
...
<div class="main">
    <div class="content">
		 ...
		 　　　　<div class="inser">
		        ...
		        <%if(mark==1){ %><input type="image" src="/maizego/images/down3.jpg"  onclick="return PrintTable(dy)" style="margin-left:7px;">
		        <%} %>
		        </div>
		 　　　　<div style=" float:right">
		         <%if(mark==1){ %>  
        ...
        <%if(mark==0){ %> 
        <div><span class="Phenotypicstrongblack"><br />&nbsp;Please return to check your input !</span></div>
        <%}else{ %>
         <div id="dy">   
				    ...
				    <tr bgcolor="#CFEEF8">	
				        ...
				        <td align="center">BackTime</td>
				        <td align="center">BackNumber</td>
				        <td align="center">BeforeNum</td>  
				        <td align="center">AfterNum</td>
		               ...
		               %>
				            ...
				            %>
							    ...
							    <%if(j==10) {%>
							    <td  align="center"><%=rs.get(11*i+j).replaceFirst("seed_","").toUpperCase()%></td> 
							   <%}else{%>
							   
							    <td  align="center"><%=rs.get(11*i+j)%></td> 
							  <% }}}%>
						   </tr>
