  ...
  <div class="span_24 padding_lr">
	           ...
	           <div id="Jobs">
				     ...
				     <div id="Jobs_content" style="font-size:16px; padding-left:10px">
				          ...
				          <ul>
				            <li><span >HIF |</span>  <a href="/maizego/Hif/ChartDisplay/chartDisplay.jsp" class="Grand3">ChartDisplay</a></li>
				            <li><span >HIF |</span>  <a href="/maizego/Hif/Chromosome/chromosome.jsp" class="Grand3">Chromosome</a></li>
