  ...
  <div class="span_24 padding_lr">
	           ...
	           <div id="Jobs">
				     ...
				     <div id="Jobs_content" style="font-size:16px; padding-left:10px">
				          ...
				          <ul>
				            <li><span >Germplasm |</span>  <a href="germsearch.action?germtypeicmenu=Search all types&&idmenu=Search all Lines" class="Grand3">Germplasm Data</a></li>
				            <li><span >Germplasm |</span>  <a href="/maizego/Germplasmlines/germ.jsp" class="Grand3">Simple Search</a></li>
