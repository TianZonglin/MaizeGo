<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="java.io.*" %>
<%@ page import="org.search.*" %>
<%@ page import="org.genotype.*" %>
    <% //获得响应客户的输出流：
      ...
      try 
      {
                GenotypicSimpleSearch ps=new GenotypicSimpleSearch();
      ...
      fw.close();  
	  //out.clear();
      response.setHeader("Content-disposition","attachment;filename="+"genotypic_data.txt");
      //通知客户文件的MIME类型：
