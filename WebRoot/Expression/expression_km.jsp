...
--></head>
 ...
 <%
  ...
  ArrayList<String> info = (ArrayList)attribute.get("info");
   ArrayList<String> wdata = (ArrayList)attribute.get("wdata");
    ...
    <div class="content">
		...
		<div style=" float:right;">
          ...
          <div>
			   ...
			   <span>Search by RPKM</span></h3> 
          </div>    <hr style=" border-top:2px solid #08b702;" />  
          		
             
            <%if(info.size()!=0){ %><!--
               		 <div>
						<span class="Phenotypicstrongblack"><br />&nbsp;From-table-75:</span>
					</div>
