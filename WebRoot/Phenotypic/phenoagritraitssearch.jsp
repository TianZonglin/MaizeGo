...
<script type="text/javascript"> 
  ...
  <%
             ...
             ArrayList<PhenoypeAgriTraits> phenotypesofcrosses_list = (ArrayList<PhenoypeAgriTraits>) attibutes.get("phenotypesofcrosses_list");
        ...
        <table cellpadding="0" cellspacing="0" width="100%" align="center" class="tab1">
				   ...
				   %>
		               ...
		               %>
					          ...
					          <tr>
							    <td align="center"><a href="phenoagritraitsadvance.jsp?trait=<%=phenotypesofcrosses_list.get(i).getTrait()%>"><%=phenotypesofcrosses_list.get(i).getTrait()%></a></td> 
								<td align="center"><%=phenotypesofcrosses_list.get(i).getPlantheight()%></td>
								<td align="center"><%=phenotypesofcrosses_list.get(i).getEarheight()%></td>
								<td align="center"><%=phenotypesofcrosses_list.get(i).getEarleafwidth()%></td>
								<td align="center"><%=phenotypesofcrosses_list.get(i).getEarleaflength()%></td>
						   </tr> 
					     <%
					       }//for 
					     }
					    ...
					    %>
						         ...
						         <td  align="center"><%=selectproperty%></td>
					    </tr>
					    <tr >
							     <td align="center"><a href="phenoagritraitsadvance.jsp?trait=<%=idmenu%>"><%=idmenu%></a></td>
