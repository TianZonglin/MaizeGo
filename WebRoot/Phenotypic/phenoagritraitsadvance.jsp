...
<div class="main">	
	   ...
	   <form name="form" id="phenotypic_scopesearch"  method="post" action="newadvancese.action" onsubmit="return check1();">	
              <input type="hidden" name="germplasmname" value="<%= request.getParameter("trait")%>";/>
              <div>
                <span class="Phenotypicstrongblack"><br />&nbsp;Trait:<%= request.getParameter("trait")%></span>
              </div>
