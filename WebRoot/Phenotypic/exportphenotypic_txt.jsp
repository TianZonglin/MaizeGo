<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="java.io.*" %>
<%@ page import="org.search.PhenotypicSearch" %> 
    ...
    <% //获得响应客户的输出流：
      ...
      try 
      {
                PhenotypicSearch ps=new PhenotypicSearch();
      ...
      fw.close();  
	  //out.clear();
      response.setHeader("Content-disposition","attachment;filename="+"exportphenotypic.txt");
      //通知客户文件的MIME类型：
