...
<div class="main">
   <div class="content">
    ...
    <div style=" float:right;">
		           <a href="/maizego/Phenotypic/pheno_csv.jsp" title="CSV File"><img src="/maizego/images/down1.jpg" /></a>　
		           <a href="/maizego/Phenotypic/pheno_txt.jsp" title=" TXT File"><img src="/maizego/images/down2.jpg" /></a>
	</div><br />
            ...
            <div style="overflow:auto;height:400px">
		     ...
		     <table cellpadding="0" cellspacing="0" style="table-layout:fixed;word-break: break-all; word-wrap: break-word;text-align:center; border:1px solid #08b702; background-color:#fff;" >
				 ...
				 //  System.out.println(amp.getString(i));
				   %>
				   <%if(amp.getString(i).equals("0.0")||amp.getString(i).equals("NA")||amp.getString(i).equals("null")){ %>
				   <td style=" border:1px solid #08b702;padding:0px ;"><%="NA"%></td>
				   <%}else{ %>
				   <td style=" border:1px solid #08b702;padding:0px ;"><%=amp.getString(i)%></td>
				   <%}} %>
				   </tr>
				   <%} %>
		         </tbody>
            ...
            <div style="overflow:auto;height:400px">
		     ...
		     <table cellpadding="0" cellspacing="0" style="table-layout:fixed;word-break: break-all; word-wrap: break-word;text-align:center; border:1px solid #08b702; background-color:#fff;" >
		         ...
		         <tbody>
				   ...
				   <%if(ril.getString(i)==null){ %>
				   <td style=" border:1px solid #08b702;padding:0px ;"><%="NA"%> </td>
				   <%}else if(ril.getString(i).equals("0.0")){ %>
				   <td style=" border:1px solid #08b702;padding:0px ;"><%="NA"%> </td>
				   <%}else{%>
				   <td style=" border:1px solid #08b702;padding:0px ;"><%=ril.getString(i) %> </td>
		     ...
		     <table cellpadding="0" cellspacing="0" style="table-layout:fixed;word-break: break-all; word-wrap: break-word;text-align:center; border:1px solid #08b702; background-color:#fff;" >
		         ...
		         <tbody>
		          <%while(f1.next()){ %>
				   ...
				   <%if(f1.getString(i)==null){ %>
				   <td style=" border:1px solid #08b702;padding:0px ;"><%="NA"%> </td>
				   <%}else if(f1.getString(i).equals("0.0")){ %>
				   <td style=" border:1px solid #08b702;padding:0px ;"><%="NA"%> </td>
				   <%}else{%>
				   <td style=" border:1px solid #08b702;padding:0px ;"><%=f1.getString(i) %> </td>
