  ...
  <div class="span_24 padding_lr">
	           ...
	           <div id="Jobs">
				     ...
				     <div id="Jobs_content" style="font-size:16px; padding-left:10px;height:420px">
				          ...
				          <ul><br/>
				            <!-- <li><span >Analysis tools|</span>  <a href="searchgraph.jsp" class="graph">Show Graph</a></li>
				          <li><span >Draw |</span>  <a href="drawvenndiagram.jsp" class="graph">Show Venn Diagram</a></li>
				             --><li><span >Analysis tools|</span>  <a href="t-test.action" class="graph">T-test</a></li>		
