...
<div class="main" >
   <div class="content" >
		 ...
		 　　　　<div style=" float:right">
		           <a href="/maizego/Seed/source_csv.jsp" title="CSV File"><img src="/maizego/images/down1.jpg" /></a>　<a href="/maizego/Seed/source_txt.jsp" title=" TXT File"><img src="/maizego/images/down2.jpg" /></a>　
				</div>
		 </div>
		 <div style="clear:both"></div>
              ...
              <table cellpadding="0" cellspacing="0" width="100%" align="center" class="tab1">
				   <tr bgcolor="#CFEEF8">										    
						    ...
						    <td width="180" align="center">Source1</td>
						    <td width="180" align="center">Source2</td>						    
						    <td width="180" align="center">LineName</td>
						    <td width="180" align="center">Remark</td>							   				  
					   </tr>
				       <%				    				        
