...
<div class="main">	
                   	 ...
                   	 <div id="Jobs_caption">
			            <ul>
			              <li class="b">BatchImport</li>
			            </ul>
			         </div>
				     <div id="Jobs_content">
	                  <form name="form" id="phenotypic"  method="post" action="upload.action" enctype="multipart/form-data" >
	                   <span class="Phenotypicstrongblack">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ImportFile：</span>
	                  <input type="file" name="upload" value="upload"/>                   
 	                 
	                  <input style="margin-top: 5px" type="image"src="/maizego/images/UPLOAD.jpg" height="36"width="130"/>
	                  </form>
	                  <div id="tip"></div>
                 </div>
	                 </div>
