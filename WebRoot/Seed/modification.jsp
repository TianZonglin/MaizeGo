...
<div class="main">
   <div class="content">
		 ...
		 　　　　<div style=" float:right">
		           <a href="/maizego/Seed/modification_csv.jsp" title="CSV File"><img src="/maizego/images/down1.jpg" /></a>　<a href="/maizego/Seed/modification_txt.jsp" title=" TXT File"><img src="/maizego/images/down2.jpg" /></a>　
				</div>
		 </div>
        ...
        <div style="overflow:auto;height:400px">
              ...
              <table cellpadding="0" cellspacing="0" width="100%" align="center" class="tab1">
				   <tr bgcolor="#CFEEF8">										    
						    ...
						    <td width="180" align="center">Modifiction No</td>
						    <td width="180" align="center">Modification Name</td>
						    <td width="180" align="center">BeforeNumber</td>
						    <td width="180" align="center">AfterNumber</td>
						    <td width="180" align="center">User</td>
						    <td width="180" align="center">Date</td>	
						     <td width="180" align="center">Population</td>				  
					   </tr>
				       <%				    				        
							for(int i=0;i<seed.size()/8;i++)
				            { 				          	         
		               %>
		                      <tr>
					        <td align="center"><%=seed.get(8*i)%></td>
				            ...
				            { 			        
					           %>
							    <td  align="center"><%=seed.get(8*i+j)%></td> 
							    <%
							  } %>
							 <td  align="center"><%=String.valueOf(seed.get(8*i+7)).replaceFirst("seed_","").toUpperCase()%></td>   
						   </tr> 
					     <%
					       }//for 
					  %>
