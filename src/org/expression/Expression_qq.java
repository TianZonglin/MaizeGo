...
public class Expression_qq extends ActionSupport{
    ...
    public String execute() throws Exception{
		...
		for(int k=0;k<data.length;k++)
		{
	   	...
	   	String sql="select * from `expression` where  Trait='"+datas.get(0)+"'";
    	for(int i=1;i<datas.size();i++){
    		sql+="or Trait='"+datas.get(i)+"' ";
    	}
		
    	String sql0="show fields from `expression`;";
		...
		String newpath=path+"file/expression_qqnormed.txt";///////////////////////////////////////
    	...
    	ArrayList<String> list1=new ArrayList<String>();
      	...
      	attribute.put("wdata1", list1);
      	attribute.put("field1", field);
    	attribute.put("info1",al);
    	return SUCCESS;
    	}catch(Exception e){
    		return ERROR;
    	}
