...
public class DbtableSearch extends ActionSupport
{
...
//		System.out.println("path: "+path);
       ...
       OutputStreamWriter osw = new OutputStreamWriter(fos,"UTF-8");
		...
		try
		{
			...
			String sql0="SELECT DISTINCT `Category` FROM download";
			...
			{
			    String sql="SELECT `Data`,`Category`,`Description`,`UpdateTime`,`Filename`FROM download";	  
