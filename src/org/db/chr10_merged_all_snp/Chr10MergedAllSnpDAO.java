 ...
 * Chr10MergedAllSnp entities. Transaction control of the save(), update() and
 * delete() operations can directly support Spring container-managed
 * transactions or they can be augmented to handle user-managed Spring
 * transactions. Each of these methods provides additional information for how
 * to configure it for the desired type of transaction control.
 * 
 * @see org.db.chr10_merged_all_snp.Chr10MergedAllSnp
 * @author MyEclipse Persistence Tools
 */

public class Chr10MergedAllSnpDAO extends BaseHibernateDAO {
	private static final Logger log = LoggerFactory
			.getLogger(Chr10MergedAllSnpDAO.class);
	// property constants
	...
	public void save(Chr10MergedAllSnp transientInstance) {
		log.debug("saving Chr10MergedAllSnp instance");
		try {
	...
	public void delete(Chr10MergedAllSnp persistentInstance) {
		log.debug("deleting Chr10MergedAllSnp instance");
		try {
	...
	public Chr10MergedAllSnp findById(java.lang.String id) {
		log.debug("getting Chr10MergedAllSnp instance with id: " + id);
		try {
			Chr10MergedAllSnp instance = (Chr10MergedAllSnp) getSession().get(
					"org.db.chr10_merged_all_snp.Chr10MergedAllSnp", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Chr10MergedAllSnp instance) {
		log.debug("finding Chr10MergedAllSnp instance by example");
		try {
			List results = getSession().createCriteria(
					"org.db.chr10_merged_all_snp.Chr10MergedAllSnp").add(
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding Chr10MergedAllSnp instance with property: "
				+ propertyName + ", value: " + value);
		try {
			String queryString = "from Chr10MergedAllSnp as model where model."
					+ propertyName + "= ?";
	...
	public List findAll() {
		log.debug("finding all Chr10MergedAllSnp instances");
		try {
			String queryString = "from Chr10MergedAllSnp";
			Query queryObject = getSession().createQuery(queryString);
			return queryObject.list();
		} catch (RuntimeException re) {
	...
	public Chr10MergedAllSnp merge(Chr10MergedAllSnp detachedInstance) {
		log.debug("merging Chr10MergedAllSnp instance");
		try {
			Chr10MergedAllSnp result = (Chr10MergedAllSnp) getSession().merge(
					detachedInstance);
	...
	public void attachDirty(Chr10MergedAllSnp instance) {
		log.debug("attaching dirty Chr10MergedAllSnp instance");
		try {
	...
	public void attachClean(Chr10MergedAllSnp instance) {
		log.debug("attaching clean Chr10MergedAllSnp instance");
		try {
