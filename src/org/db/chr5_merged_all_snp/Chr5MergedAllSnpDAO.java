 ...
 * Chr5MergedAllSnp entities. Transaction control of the save(), update() and
 * delete() operations can directly support Spring container-managed
 * transactions or they can be augmented to handle user-managed Spring
 * transactions. Each of these methods provides additional information for how
 * to configure it for the desired type of transaction control.
 * 
 * @see org.db.chr5_merged_all_snp.Chr5MergedAllSnp
 * @author MyEclipse Persistence Tools
 */

public class Chr5MergedAllSnpDAO extends BaseHibernateDAO {
	private static final Logger log = LoggerFactory
			.getLogger(Chr5MergedAllSnpDAO.class);
	// property constants
	...
	public void save(Chr5MergedAllSnp transientInstance) {
		log.debug("saving Chr5MergedAllSnp instance");
		try {
	...
	public void delete(Chr5MergedAllSnp persistentInstance) {
		log.debug("deleting Chr5MergedAllSnp instance");
		try {
	...
	public Chr5MergedAllSnp findById(java.lang.String id) {
		log.debug("getting Chr5MergedAllSnp instance with id: " + id);
		try {
			Chr5MergedAllSnp instance = (Chr5MergedAllSnp) getSession().get(
					"org.db.chr5_merged_all_snp.Chr5MergedAllSnp", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Chr5MergedAllSnp instance) {
		log.debug("finding Chr5MergedAllSnp instance by example");
		try {
			List results = getSession().createCriteria(
					"org.db.chr5_merged_all_snp.Chr5MergedAllSnp").add(
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding Chr5MergedAllSnp instance with property: "
				+ propertyName + ", value: " + value);
		try {
			String queryString = "from Chr5MergedAllSnp as model where model."
					+ propertyName + "= ?";
	...
	public List findAll() {
		log.debug("finding all Chr5MergedAllSnp instances");
		try {
			String queryString = "from Chr5MergedAllSnp";
			Query queryObject = getSession().createQuery(queryString);
			return queryObject.list();
		} catch (RuntimeException re) {
	...
	public Chr5MergedAllSnp merge(Chr5MergedAllSnp detachedInstance) {
		log.debug("merging Chr5MergedAllSnp instance");
		try {
			Chr5MergedAllSnp result = (Chr5MergedAllSnp) getSession().merge(
					detachedInstance);
	...
	public void attachDirty(Chr5MergedAllSnp instance) {
		log.debug("attaching dirty Chr5MergedAllSnp instance");
		try {
	...
	public void attachClean(Chr5MergedAllSnp instance) {
		log.debug("attaching clean Chr5MergedAllSnp instance");
		try {
