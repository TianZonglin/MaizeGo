 ...
 * Chr8MergedAllSnp entities. Transaction control of the save(), update() and
 * delete() operations can directly support Spring container-managed
 * transactions or they can be augmented to handle user-managed Spring
 * transactions. Each of these methods provides additional information for how
 * to configure it for the desired type of transaction control.
 * 
 * @see org.db.chr8_merged_all_snp.Chr8MergedAllSnp
 * @author MyEclipse Persistence Tools
 */

public class Chr8MergedAllSnpDAO extends BaseHibernateDAO {
	private static final Logger log = LoggerFactory
			.getLogger(Chr8MergedAllSnpDAO.class);
	// property constants
	...
	public void save(Chr8MergedAllSnp transientInstance) {
		log.debug("saving Chr8MergedAllSnp instance");
		try {
	...
	public void delete(Chr8MergedAllSnp persistentInstance) {
		log.debug("deleting Chr8MergedAllSnp instance");
		try {
	...
	public Chr8MergedAllSnp findById(java.lang.String id) {
		log.debug("getting Chr8MergedAllSnp instance with id: " + id);
		try {
			Chr8MergedAllSnp instance = (Chr8MergedAllSnp) getSession().get(
					"org.db.chr8_merged_all_snp.Chr8MergedAllSnp", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Chr8MergedAllSnp instance) {
		log.debug("finding Chr8MergedAllSnp instance by example");
		try {
			List results = getSession().createCriteria(
					"org.db.chr8_merged_all_snp.Chr8MergedAllSnp").add(
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding Chr8MergedAllSnp instance with property: "
				+ propertyName + ", value: " + value);
		try {
			String queryString = "from Chr8MergedAllSnp as model where model."
					+ propertyName + "= ?";
	...
	public List findAll() {
		log.debug("finding all Chr8MergedAllSnp instances");
		try {
			String queryString = "from Chr8MergedAllSnp";
			Query queryObject = getSession().createQuery(queryString);
			return queryObject.list();
		} catch (RuntimeException re) {
	...
	public Chr8MergedAllSnp merge(Chr8MergedAllSnp detachedInstance) {
		log.debug("merging Chr8MergedAllSnp instance");
		try {
			Chr8MergedAllSnp result = (Chr8MergedAllSnp) getSession().merge(
					detachedInstance);
	...
	public void attachDirty(Chr8MergedAllSnp instance) {
		log.debug("attaching dirty Chr8MergedAllSnp instance");
		try {
	...
	public void attachClean(Chr8MergedAllSnp instance) {
		log.debug("attaching clean Chr8MergedAllSnp instance");
		try {
