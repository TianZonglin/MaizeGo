package org.db.chr4_merged_all_snp;
 ...
 * Chr4MergedAllSnp entities. Transaction control of the save(), update() and
 * delete() operations can directly support Spring container-managed
 * transactions or they can be augmented to handle user-managed Spring
 * transactions. Each of these methods provides additional information for how
 * to configure it for the desired type of transaction control.
 * 
 * @see org.db.chr4_merged_all_snp.Chr4MergedAllSnp
 * @author MyEclipse Persistence Tools
 */

public class Chr4MergedAllSnpDAO extends BaseHibernateDAO {
	private static final Logger log = LoggerFactory
			.getLogger(Chr4MergedAllSnpDAO.class);
	// property constants
	...
	public void save(Chr4MergedAllSnp transientInstance) {
		log.debug("saving Chr4MergedAllSnp instance");
		try {
	...
	public void delete(Chr4MergedAllSnp persistentInstance) {
		log.debug("deleting Chr4MergedAllSnp instance");
		try {
	...
	public Chr4MergedAllSnp findById(java.lang.String id) {
		log.debug("getting Chr4MergedAllSnp instance with id: " + id);
		try {
			Chr4MergedAllSnp instance = (Chr4MergedAllSnp) getSession().get(
					"org.db.chr4_merged_all_snp.Chr4MergedAllSnp", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Chr4MergedAllSnp instance) {
		log.debug("finding Chr4MergedAllSnp instance by example");
		try {
			List results = getSession().createCriteria(
					"org.db.chr4_merged_all_snp.Chr4MergedAllSnp").add(
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding Chr4MergedAllSnp instance with property: "
				+ propertyName + ", value: " + value);
		try {
			String queryString = "from Chr4MergedAllSnp as model where model."
					+ propertyName + "= ?";
	...
	public List findAll() {
		log.debug("finding all Chr4MergedAllSnp instances");
		try {
			String queryString = "from Chr4MergedAllSnp";
			Query queryObject = getSession().createQuery(queryString);
			return queryObject.list();
		} catch (RuntimeException re) {
	...
	public Chr4MergedAllSnp merge(Chr4MergedAllSnp detachedInstance) {
		log.debug("merging Chr4MergedAllSnp instance");
		try {
			Chr4MergedAllSnp result = (Chr4MergedAllSnp) getSession().merge(
					detachedInstance);
	...
	public void attachDirty(Chr4MergedAllSnp instance) {
		log.debug("attaching dirty Chr4MergedAllSnp instance");
		try {
	...
	public void attachClean(Chr4MergedAllSnp instance) {
		log.debug("attaching clean Chr4MergedAllSnp instance");
		try {
