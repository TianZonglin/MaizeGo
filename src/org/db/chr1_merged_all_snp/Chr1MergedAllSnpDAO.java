 ...
 * Chr1MergedAllSnp entities. Transaction control of the save(), update() and
 * delete() operations can directly support Spring container-managed
 * transactions or they can be augmented to handle user-managed Spring
 * transactions. Each of these methods provides additional information for how
 * to configure it for the desired type of transaction control.
 * 
 * @see org.db.chr1_merged_all_snp.Chr1MergedAllSnp
 * @author MyEclipse Persistence Tools
 */

public class Chr1MergedAllSnpDAO extends BaseHibernateDAO {
	private static final Logger log = LoggerFactory
			.getLogger(Chr1MergedAllSnpDAO.class);
	// property constants
	...
	public void save(Chr1MergedAllSnp transientInstance) {
		log.debug("saving Chr1MergedAllSnp instance");
		try {
	...
	public void delete(Chr1MergedAllSnp persistentInstance) {
		log.debug("deleting Chr1MergedAllSnp instance");
		try {
	...
	public Chr1MergedAllSnp findById(java.lang.String id) {
		log.debug("getting Chr1MergedAllSnp instance with id: " + id);
		try {
			Chr1MergedAllSnp instance = (Chr1MergedAllSnp) getSession().get(
					"org.db.chr1_merged_all_snp.Chr1MergedAllSnp", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Chr1MergedAllSnp instance) {
		log.debug("finding Chr1MergedAllSnp instance by example");
		try {
			List results = getSession().createCriteria(
					"org.db.chr1_merged_all_snp.Chr1MergedAllSnp").add(
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding Chr1MergedAllSnp instance with property: "
				+ propertyName + ", value: " + value);
		try {
			String queryString = "from Chr1MergedAllSnp as model where model."
					+ propertyName + "= ?";
	...
	public List findAll() {
		log.debug("finding all Chr1MergedAllSnp instances");
		try {
			String queryString = "from Chr1MergedAllSnp";
			Query queryObject = getSession().createQuery(queryString);
			return queryObject.list();
		} catch (RuntimeException re) {
	...
	public Chr1MergedAllSnp merge(Chr1MergedAllSnp detachedInstance) {
		log.debug("merging Chr1MergedAllSnp instance");
		try {
			Chr1MergedAllSnp result = (Chr1MergedAllSnp) getSession().merge(
					detachedInstance);
	...
	public void attachDirty(Chr1MergedAllSnp instance) {
		log.debug("attaching dirty Chr1MergedAllSnp instance");
		try {
	...
	public void attachClean(Chr1MergedAllSnp instance) {
		log.debug("attaching clean Chr1MergedAllSnp instance");
		try {
