 ...
 * Chr3MergedAllSnp entities. Transaction control of the save(), update() and
 * delete() operations can directly support Spring container-managed
 * transactions or they can be augmented to handle user-managed Spring
 * transactions. Each of these methods provides additional information for how
 * to configure it for the desired type of transaction control.
 * 
 * @see org.db.chr3_merged_all_snp.Chr3MergedAllSnp
 * @author MyEclipse Persistence Tools
 */

public class Chr3MergedAllSnpDAO extends BaseHibernateDAO {
	private static final Logger log = LoggerFactory
			.getLogger(Chr3MergedAllSnpDAO.class);
	// property constants
	...
	public void save(Chr3MergedAllSnp transientInstance) {
		log.debug("saving Chr3MergedAllSnp instance");
		try {
	...
	public void delete(Chr3MergedAllSnp persistentInstance) {
		log.debug("deleting Chr3MergedAllSnp instance");
		try {
	...
	public Chr3MergedAllSnp findById(java.lang.String id) {
		log.debug("getting Chr3MergedAllSnp instance with id: " + id);
		try {
			Chr3MergedAllSnp instance = (Chr3MergedAllSnp) getSession().get(
					"org.db.chr3_merged_all_snp.Chr3MergedAllSnp", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Chr3MergedAllSnp instance) {
		log.debug("finding Chr3MergedAllSnp instance by example");
		try {
			List results = getSession().createCriteria(
					"org.db.chr3_merged_all_snp.Chr3MergedAllSnp").add(
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding Chr3MergedAllSnp instance with property: "
				+ propertyName + ", value: " + value);
		try {
			String queryString = "from Chr3MergedAllSnp as model where model."
					+ propertyName + "= ?";
	...
	public List findAll() {
		log.debug("finding all Chr3MergedAllSnp instances");
		try {
			String queryString = "from Chr3MergedAllSnp";
			Query queryObject = getSession().createQuery(queryString);
			return queryObject.list();
		} catch (RuntimeException re) {
	...
	public Chr3MergedAllSnp merge(Chr3MergedAllSnp detachedInstance) {
		log.debug("merging Chr3MergedAllSnp instance");
		try {
			Chr3MergedAllSnp result = (Chr3MergedAllSnp) getSession().merge(
					detachedInstance);
	...
	public void attachDirty(Chr3MergedAllSnp instance) {
		log.debug("attaching dirty Chr3MergedAllSnp instance");
		try {
	...
	public void attachClean(Chr3MergedAllSnp instance) {
		log.debug("attaching clean Chr3MergedAllSnp instance");
		try {
