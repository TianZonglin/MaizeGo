 ...
 * Chr7MergedAllSnp entities. Transaction control of the save(), update() and
 * delete() operations can directly support Spring container-managed
 * transactions or they can be augmented to handle user-managed Spring
 * transactions. Each of these methods provides additional information for how
 * to configure it for the desired type of transaction control.
 * 
 * @see org.db.chr7_merged_all_snp.Chr7MergedAllSnp
 * @author MyEclipse Persistence Tools
 */

public class Chr7MergedAllSnpDAO extends BaseHibernateDAO {
	private static final Logger log = LoggerFactory
			.getLogger(Chr7MergedAllSnpDAO.class);
	// property constants
	...
	public void save(Chr7MergedAllSnp transientInstance) {
		log.debug("saving Chr7MergedAllSnp instance");
		try {
	...
	public void delete(Chr7MergedAllSnp persistentInstance) {
		log.debug("deleting Chr7MergedAllSnp instance");
		try {
	...
	public Chr7MergedAllSnp findById(java.lang.String id) {
		log.debug("getting Chr7MergedAllSnp instance with id: " + id);
		try {
			Chr7MergedAllSnp instance = (Chr7MergedAllSnp) getSession().get(
					"org.db.chr7_merged_all_snp.Chr7MergedAllSnp", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Chr7MergedAllSnp instance) {
		log.debug("finding Chr7MergedAllSnp instance by example");
		try {
			List results = getSession().createCriteria(
					"org.db.chr7_merged_all_snp.Chr7MergedAllSnp").add(
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding Chr7MergedAllSnp instance with property: "
				+ propertyName + ", value: " + value);
		try {
			String queryString = "from Chr7MergedAllSnp as model where model."
					+ propertyName + "= ?";
	...
	public List findAll() {
		log.debug("finding all Chr7MergedAllSnp instances");
		try {
			String queryString = "from Chr7MergedAllSnp";
			Query queryObject = getSession().createQuery(queryString);
			return queryObject.list();
		} catch (RuntimeException re) {
	...
	public Chr7MergedAllSnp merge(Chr7MergedAllSnp detachedInstance) {
		log.debug("merging Chr7MergedAllSnp instance");
		try {
			Chr7MergedAllSnp result = (Chr7MergedAllSnp) getSession().merge(
					detachedInstance);
	...
	public void attachDirty(Chr7MergedAllSnp instance) {
		log.debug("attaching dirty Chr7MergedAllSnp instance");
		try {
	...
	public void attachClean(Chr7MergedAllSnp instance) {
		log.debug("attaching clean Chr7MergedAllSnp instance");
		try {
