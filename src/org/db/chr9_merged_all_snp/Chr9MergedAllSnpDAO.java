 ...
 * Chr9MergedAllSnp entities. Transaction control of the save(), update() and
 * delete() operations can directly support Spring container-managed
 * transactions or they can be augmented to handle user-managed Spring
 * transactions. Each of these methods provides additional information for how
 * to configure it for the desired type of transaction control.
 * 
 * @see org.db.chr9_merged_all_snp.Chr9MergedAllSnp
 * @author MyEclipse Persistence Tools
 */

public class Chr9MergedAllSnpDAO extends BaseHibernateDAO {
	private static final Logger log = LoggerFactory
			.getLogger(Chr9MergedAllSnpDAO.class);
	// property constants
	...
	public void save(Chr9MergedAllSnp transientInstance) {
		log.debug("saving Chr9MergedAllSnp instance");
		try {
	...
	public void delete(Chr9MergedAllSnp persistentInstance) {
		log.debug("deleting Chr9MergedAllSnp instance");
		try {
	...
	public Chr9MergedAllSnp findById(java.lang.String id) {
		log.debug("getting Chr9MergedAllSnp instance with id: " + id);
		try {
			Chr9MergedAllSnp instance = (Chr9MergedAllSnp) getSession().get(
					"org.db.chr9_merged_all_snp.Chr9MergedAllSnp", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Chr9MergedAllSnp instance) {
		log.debug("finding Chr9MergedAllSnp instance by example");
		try {
			List results = getSession().createCriteria(
					"org.db.chr9_merged_all_snp.Chr9MergedAllSnp").add(
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding Chr9MergedAllSnp instance with property: "
				+ propertyName + ", value: " + value);
		try {
			String queryString = "from Chr9MergedAllSnp as model where model."
					+ propertyName + "= ?";
	...
	public List findAll() {
		log.debug("finding all Chr9MergedAllSnp instances");
		try {
			String queryString = "from Chr9MergedAllSnp";
			Query queryObject = getSession().createQuery(queryString);
			return queryObject.list();
		} catch (RuntimeException re) {
	...
	public Chr9MergedAllSnp merge(Chr9MergedAllSnp detachedInstance) {
		log.debug("merging Chr9MergedAllSnp instance");
		try {
			Chr9MergedAllSnp result = (Chr9MergedAllSnp) getSession().merge(
					detachedInstance);
	...
	public void attachDirty(Chr9MergedAllSnp instance) {
		log.debug("attaching dirty Chr9MergedAllSnp instance");
		try {
	...
	public void attachClean(Chr9MergedAllSnp instance) {
		log.debug("attaching clean Chr9MergedAllSnp instance");
		try {
